import {
  Injectable, Inject, ConflictException, BadRequestException, NotFoundException,
} from '@nestjs/common';
import {
...
import { STRIPE_SERVICE, IStripeService } from '../../domain/ports/stripe.service.port';
...
export class CreerReservationUseCase {
  ...
  async execute(command: CreerReservationCommand): Promise<CreerReservationResult> {
